...
urlpatterns = [
    ...
    path('cotizaciones/<int:quotation_id>/wa/enviar/', views.quotation_wa_share, name='quotation_wa_share'),
    path('cotizaciones/<int:quotation_id>/wa/recordatorio-pago/', views.quotation_wa_payment_reminder, name='quotation_wa_payment_reminder'),
    path('cotizaciones/<int:quotation_id>/editar/', views.quotation_edit, name='quotation_edit'),
    path('cotizaciones/<int:quotation_id>/editar/cancelar/', views.quotation_edit_cancel, name='quotation_edit_cancel'),
    ...
    path('requisitos/<uuid:token>/ajax/guardar/', views.client_rental_requirements_save, name='client_rental_requirements_save'),
    path('requisitos/<uuid:token>/ajax/finalizar/', views.client_rental_requirements_finalize, name='client_rental_requirements_finalize'),
