...
class SiteSettingsForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = (
            ...
            'company_rep_name',
            'company_tax_regime',
            'company_is_grand_contributor',
            'dian_invoice_resolution',
            'cuenta_cobro_payment_days',
            'cuenta_cobro_ica_per_mille',
            'jurisdiction_city',
            'instagram_url',
            'tiktok_url',
            'facebook_url',
        ...
        widgets = {
            ...
            'company_tax_regime': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Régimen común'}),
            'company_is_grand_contributor': forms.CheckboxInput(attrs={'class': 'form-check-input'}),
            'dian_invoice_resolution': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Ej: 18764000001234'}),
            'cuenta_cobro_payment_days': forms.NumberInput(attrs={'class': 'form-control', 'min': 0, 'max': 120}),
            'cuenta_cobro_ica_per_mille': forms.NumberInput(attrs={'class': 'form-control', 'step': '0.0001', 'min': 0}),
        ...
        labels = {
            ...
            'company_tax_regime': 'Régimen tributario (cuenta de cobro)',
            'company_is_grand_contributor': 'Somos Gran Contribuyente (DIAN)',
            'dian_invoice_resolution': 'Resolución DIAN facturación electrónica',
            'cuenta_cobro_payment_days': 'Plazo de pago cuenta de cobro (días)',
            'cuenta_cobro_ica_per_mille': 'Retención ICA (‰ sobre base)',
